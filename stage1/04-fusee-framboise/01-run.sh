...
curl -L -o ${ROOTFS_DIR}/etc/fusee-launcher/hekate.zip "https://github.com/CTCaer/hekate/releases/download/v5.5.2/hekate_ctcaer_5.5.2_Nyx_0.9.8.zip"

unzip ${ROOTFS_DIR}/etc/fusee-launcher/hekate.zip -d ${ROOTFS_DIR}/etc/fusee-launcher

mv -v ${ROOTFS_DIR}/etc/fusee-launcher/hekate_ctcaer_5.5.2.bin ${ROOTFS_DIR}/etc/fusee-launcher/fusee.bin
