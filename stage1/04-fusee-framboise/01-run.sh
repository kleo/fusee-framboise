...
curl -L -o ${ROOTFS_DIR}/etc/fusee-launcher/hekate.zip "https://github.com/CTCaer/hekate/releases/download/v5.3.4/hekate_ctcaer_5.3.4_Nyx_0.9.5.zip"

unzip ${ROOTFS_DIR}/etc/fusee-launcher/hekate.zip -d ${ROOTFS_DIR}/etc/fusee-launcher

mv -v ${ROOTFS_DIR}/etc/fusee-launcher/hekate_ctcaer_5.3.4.bin ${ROOTFS_DIR}/etc/fusee-launcher/fusee.bin
